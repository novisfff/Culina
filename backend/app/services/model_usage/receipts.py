...
def receipt_log_payload(receipt: ProviderUsageReceipt) -> dict[str, object]:
    payload = {
        ...
        "config_revision_id": receipt.config_revision_id,
        "provider_profile_id": receipt.provider_profile_id,
        "provider_profile_version_id": receipt.provider_profile_version_id,
        "search_profile_id": receipt.search_profile_id,
...
def provider_usage_receipt_from_log_payload(
    ...
    try:
        ...
        return ProviderUsageReceipt(
            ...
            config_revision_id=_optional_string(payload["config_revision_id"]),
            provider_profile_id=_optional_string(payload["provider_profile_id"]),
            provider_profile_version_id=_optional_string(
                payload["provider_profile_version_id"]
            ),
            search_profile_id=_optional_string(payload["search_profile_id"]),
