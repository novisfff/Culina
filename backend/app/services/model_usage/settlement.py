...
def _validate_identity(
    ...
    checks = (
        ...
        reservation.config_revision_id == receipt.config_revision_id,
        reservation.provider_profile_id == receipt.provider_profile_id,
        reservation.provider_profile_version_id == receipt.provider_profile_version_id,
        reservation.search_profile_id == receipt.search_profile_id,
        pricing_identity_matches,
