...
export const loadModelUsageWorkspace = createRouteEntryLoader(
  'model-usage',
  () => Promise.all([import('../../styles/route-overlays').then((module) => module.loadRouteOverlayStyles()), import('../../features/model-usage/model-usage-route.css')]),
...
export const loadFamilyModelSettings = createRouteEntryLoader(
  ...
  () => Promise.all([import('../../styles/route-overlays').then((module) => module.loadRouteOverlayStyles()), import('../../features/family-model-settings/family-model-settings-route.css')]),
