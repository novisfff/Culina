...
function buildIngredientView(item: SearchResultItem): GlobalSearchResultView {
  ...
  return {
    ...
    description: compactParts([ingredient.category, ingredient.default_storage, ingredient.notes]) || '食材信息',
...
function buildMealPlanView(item: SearchResultItem): GlobalSearchResultView {
  ...
  return {
    ...
    description: compactParts([plan.plan_date, mealLabel, statusLabel, plan.note]) || '餐食计划',
