import type { ModelUsageRequestLogPage } from '../../api/types';
...
function statusLabel(item: ModelUsageRequestLogPage['items'][number]): string {
...
function meterSummary(item: ModelUsageRequestLogPage['items'][number]): string {
  return item.meters
    .slice(0, 3)
