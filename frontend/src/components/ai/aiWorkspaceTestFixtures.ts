...
export function qualityMetrics(overrides: Partial<AiQualityMetrics> = {}): AiQualityMetrics {
  return {
    ...
    totals: {
      ...
      routeSelectionCount: 3,
      draftValidationCandidateCount: 5,
      draftValidationAttemptCount: 5,
      draftFirstPassSuccessCount: 4,
      invalidIdentityRejectedCount: 2,
    ...
    operational_metrics: {
      draftFirstPassRate: { numerator: 4, denominator: 5, rate: 0.8 },
      continuationCompletionRate: { numerator: 2, denominator: 3, rate: 0.6667 },
      approvalUneditedRate: { numerator: 1, denominator: 2, rate: 0.5 },
      invalidIdentityRejectedCount: 2,
      toolBudgetExhaustedCount: 1,
      continuationRejectedCount: 1,
    },
