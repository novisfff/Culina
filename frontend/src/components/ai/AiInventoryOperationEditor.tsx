      ...
      {operations.map((item, index) => {
        ...
        return (
          <div
            ...
            key={detailKey}
          >
            <div className="ai-inventory-operation-summary">
              {image ? (
                <img src={resolveMediaUrl(image, 'thumb') ?? ''} alt="" />
              ) : (
            ...
            <div className="ai-confirmation-grid ai-confirmation-grid-compact">
              <label className="ai-resource-field">
                <span>{action === 'restock' ? '入库数量' : action === 'dispose' ? '销毁数量' : '消耗数量'}</span>
                <input
            ...
            {action === 'dispose' && (
              <>
                <div className="ai-inventory-batch-summary">
                  <span>销毁批次</span>
                  <strong>
